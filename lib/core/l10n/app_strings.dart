...
const Map<String, (String, String, String)> _table = {
  ...
  'common.download': ('İndir', 'Download', 'تنزيل'),
  'ink.title': ('Kalemle düzenle', 'Draw & annotate', 'الرسم والتعليق'),
  'ink.pen': ('Kalem', 'Pen', 'قلم'),
  'ink.highlighter': ('Fosforlu', 'Highlighter', 'قلم تمييز'),
  'ink.text': ('Yazı', 'Text', 'نص'),
  'ink.eraser': ('Silgi', 'Eraser', 'ممحاة'),
  ...
  'ink.size_m': ('Orta', 'Medium', 'متوسط'),
  'ink.size_l': ('Büyük', 'Large', 'كبير'),
  'ink.unsaved_title': ('Çizimler kaydedilmedi', 'Unsaved marks', 'علامات غير محفوظة'),
  'ink.unsaved_body': ('Yaptığın çizim ve yazılar kaydedilsin mi?', 'Save your drawings and text?', 'هل تريد حفظ الرسومات والنصوص؟'),
  'ink.save_note': ('Çizimler ve yazılar sayfaya kalıcı olarak işlenir.', 'Drawings and text are permanently added to the pages.', 'تُضاف الرسومات والنصوص إلى الصفحات بشكل دائم.'),
  'ink.failed': ('Kaydedilemedi: {error}', 'Could not save: {error}', 'تعذّر الحفظ: {error}'),
  'dl.saved': ("İndirilenler'e kaydedildi: {name}", 'Saved to Downloads: {name}', 'تم الحفظ في التنزيلات: {name}'),
  'dl.already_saved': ("Zaten İndirilenler'de: {name}", 'Already in Downloads: {name}', 'موجود بالفعل في التنزيلات: {name}'),
  'dl.save_failed': ("İndirilenler'e kaydedilemedi: {error}", 'Could not save to Downloads: {error}', 'تعذّر الحفظ في التنزيلات: {error}'),
  'dl.show': ('Göster', 'Show', 'عرض'),
  'dl.from_browser': ("Tarayıcıdan açılan dosya İndirilenler'e kaydedildi: {name}", 'File opened from the browser was saved to Downloads: {name}', 'تم حفظ الملف المفتوح من المتصفح في التنزيلات: {name}'),
  ...
  // 2026-09-23 tasarım turu — belge kabuğu, "Daha fazla" sayfası, okuma ayarları
  'shell.unsaved': ('Kaydedilmedi', 'Unsaved', 'غير محفوظ'),
  'shell.pages': ('{n} sayfa', '{n} pages', '{n} صفحة'),
  'shell.slides': ('{n} slayt', '{n} slides', '{n} شريحة'),
  'shell.sheets': ('{n} sayfa', '{n} sheets', '{n} أوراق'),
  'dm.view': ('Görünüm', 'View', 'العرض'),
  'dm.page': ('Sayfa', 'Page', 'الصفحة'),
  'dm.edit_sign': ('Düzenle ve imzala', 'Edit & sign', 'التحرير والتوقيع'),
  'dm.text': ('Metin', 'Text', 'النص'),
  'dm.convert': ('Dönüştür ve dinle', 'Convert & listen', 'التحويل والاستماع'),
  'dm.file': ('Dosya', 'File', 'الملف'),
  'vw.reading_settings': ('Okuma ayarları', 'Reading settings', 'إعدادات القراءة'),
  'vw.text_size': ('Yazı boyutu', 'Text size', 'حجم الخط'),
  'vw.font_default': ('Varsayılan', 'Default', 'الافتراضي'),
  'vw.layout': ('Düzen', 'Layout', 'التخطيط'),
  'vw.speak_part': ('Bölüm {n} / {total}', 'Part {n} of {total}', 'الجزء {n} من {total}'),
  'find.none': ('Sonuç yok', 'No results', 'لا نتائج'),
  'gal.info': ('Bilgi', 'Info', 'معلومات'),
  'gal.tools': ('Araçlar', 'Tools', 'الأدوات'),
  ...
  // 2026-08-08: son kalan sabit Türkçe metinler buraya taşındı — uygulamada
  // artık kullanıcıya görünen çevrilmemiş dize YOK (`l10n_literals_test`
  // yenisini eklemeyi derleme değil TEST hatası yapar).
  'common.undo': ('Geri al', 'Undo', 'تراجع'),
  ...
  'common.deleting': ('Siliniyor', 'Deleting', 'جارٍ الحذف'),
  'common.saved_hint': (
  ...
  'settings.appearance': ('Görünüm ve dil', 'Appearance & language', 'المظهر واللغة'),
  'settings.appearance_sub': (
    'Tema ve arayüz dili',
  ...
  'settings.ai_sub': (
    ...
    'مفتاح Gemini واختيار النموذج',
  ),
  'settings.memory_sub': (
    'Yapay zekânın hatırlamasını istediğiniz notlar',
  ...
  'settings.fm_sub': (
    ...
    'Thumbnails, hidden files, trash',
    'الصور المصغّرة والملفات المخفية وسلة المهملات',
  ),
  'settings.fm_open': (
    'Dosya yöneticisi ayarlarını aç',
    'Open file manager settings',
    'فتح إعدادات مدير الملفات',
  ),
  'settings.about_sub': (
    'Sürüm bilgisi ve lisanslar',
    'Version info and licenses',
    'معلومات الإصدار والتراخيص',
  ),
  ...
  'paste.conflict_title': (
    'Hedefte {n} dosya zaten var',
    '{n} files already exist here',
    'يوجد {n} ملف بالفعل هنا',
  ),
  'paste.conflict_more': (
    '{names} ve {n} dosya daha',
    '{names} and {n} more',
    '{names} و{n} ملفات أخرى',
  ),
  'paste.keep_both': ('İkisini de tut', 'Keep both', 'الاحتفاظ بالاثنين'),
  'paste.keep_both_sub': (
    'Yenisine “(1)” eklenir, hiçbir şey silinmez',
    'The new one gets “(1)”; nothing is deleted',
    'يُضاف “(1)” إلى الجديد ولا يُحذف شيء',
  ),
  'paste.skip': ('Bu dosyaları atla', 'Skip these files', 'تخطي هذه الملفات'),
  'paste.skip_sub': (
    'Hedefteki dosyalar olduğu gibi kalır',
    'The files already here stay as they are',
    'تبقى الملفات الموجودة كما هي',
  ),
  'paste.overwrite': ('Üzerine yaz', 'Overwrite', 'استبدال'),
  'paste.overwrite_sub': (
    'Hedefteki dosyalar silinir — geri alınamaz',
    'The files already here are replaced — cannot be undone',
    'تُستبدل الملفات الموجودة — لا يمكن التراجع',
  ),
  'fm.clipboard_ready': (
    '{n} öğe {verb} hazır',
  ...
  'fm.clear_finished': ('Bitenleri temizle', 'Clear finished', 'مسح المنتهية'),
  'fm.ask_gemini': ('Gemini’ye sor', 'Ask Gemini', 'اسأل Gemini'),
  'fm.new_word_doc': (
    'Word belgesi (.docx)',
    'Word document (.docx)',
    'مستند Word ‏(.docx)',
  ...
  'fm.pin_enter': ('PIN girin', 'Enter PIN', 'أدخل رمز PIN'),
  'fm.pin_new': ('Yeni PIN', 'New PIN', 'رمز PIN جديد'),
  'fm.pin_label': ('PIN', 'PIN', 'رمز PIN'),
  'fm.pin_repeat': ('PIN (tekrar)', 'PIN (again)', 'رمز PIN (تكرار)'),
  ...
  'vw.highlight_remove': ('Vurguyu kaldır', 'Remove highlight', 'إزالة التمييز'),
  'vw.highlight_removed': (
    '{n} vurgu kaldırıldı.',
    '{n} highlight(s) removed.',
    'تمت إزالة {n} تمييز.',
  ),
  'vw.highlight_none_here': (
    'Seçtiğiniz yerde vurgu yok.',
    'There is no highlight where you selected.',
    'لا يوجد تمييز في المكان الذي حددته.',
  ),
  ...
  'pt.export_images': ('Sayfaları görsel yap (PNG)', 'Export pages as images (PNG)', 'تصدير الصفحات كصور (PNG)'),
  'pt.op_export_images': ('Görseller üretiliyor', 'Creating images', 'جارٍ إنشاء الصور'),
  'pt.export_images_count': ('{n} sayfa görseli', '{n} page images', '{n} صورة صفحة'),
  'pt.export_images_limit': (
    'Tek seferde en fazla {n} sayfa: önce sayfaları seçin.',
    'At most {n} pages at a time: select the pages first.',
    'بحد أقصى {n} صفحة في المرة: اختر الصفحات أولًا.',
  ),
  'pt.export_images_failed': (
    'Sayfa görseli üretilemedi',
    'Could not create page images',
    'تعذّر إنشاء صور الصفحات',
  ),
  ...
  'clean.confirm_title': ('Temizlensin mi?', 'Clean up?', 'هل تريد التنظيف؟'),
  ...
  'ana.scope_all': ('Tümü', 'All', 'الكل'),
  'ana.filter_count': ('{n} filtre', '{n} filters', '{n} مرشّح'),
  ...
  // ── Uzak/USB gezgini: seçim, kopyalama, sıralama (2026-09-02) ────────
  'nas.copy_to_phone': (
    'Telefona kopyala',
    'Copy to phone',
    'نسخ إلى الهاتف',
  ...
  'nas.copied_to_phone': (
    'İndirilenler/Dosya Okuyucu klasörüne kopyalandı',
    'Copied to Download/Dosya Okuyucu',
    'تم النسخ إلى مجلد التنزيلات',
  ),
  'nas.copy_only_files': (
    'Yalnız dosyalar kopyalanabiliyor (klasör seçilmiş).',
    'Only files can be copied (a folder is selected).',
    'يمكن نسخ الملفات فقط.',
  ),
  'nas.copy_skipped_dirs': ('klasör atlandı', 'folders skipped', 'مجلدات متخطاة'),
  'nas.copying': ('Kopyalanıyor', 'Copying', 'جارٍ النسخ'),
  'nas.filter_hint': ('Bu klasörde süz', 'Filter this folder', 'تصفية هذا المجلد'),
  'nas.no_match': ('Süzgece uyan dosya yok.', 'No matching files.', 'لا ملفات مطابقة.'),
  'nas.delete_many': ('{n} öğe silinsin mi?', 'Delete {n} items?', 'حذف {n} عنصرًا؟'),
  'nas.sort_name': ('Ada göre', 'By name', 'حسب الاسم'),
  'nas.sort_size': ('Boyuta göre', 'By size', 'حسب الحجم'),
  'nas.sort_date': ('Tarihe göre', 'By date', 'حسب التاريخ'),
  'nas.sort_ascending': ('Artan sıra', 'Ascending', 'تصاعدي'),
  ...
  'drive.info_created': ('Oluşturulma', 'Created', 'تاريخ الإنشاء'),
  'drive.info_owner': ('Sahibi', 'Owner', 'المالك'),
  'drive.info_shared': ('Paylaşım', 'Sharing', 'المشاركة'),
  'drive.info_starred': ('Yıldızlı', 'Starred', 'المميزة بنجمة'),
  'drive.shared_yes': (
    'Paylaşılmış',
    'Shared with others',
    'مُشارَك مع آخرين',
  ),
  'drive.shared_no': ('Yalnız siz', 'Only you', 'أنت فقط'),
  'drive.sort': ('Sıralama', 'Sort', 'الترتيب'),
  ...
  'fm.quick_opened_within': (
    'Son {n} ayda açılanlar',
    'Opened in the last {n} months',
    'فُتح خلال آخر {n} أشهر',
  ),
  ...
  // Şerit sekmeleri (Excel'in kendi adları).
  'excel.tab_home': ('Giriş', 'Home', 'الصفحة الرئيسية'),
  'excel.tab_insert': ('Ekle', 'Insert', 'إدراج'),
  'excel.tab_data': ('Veri', 'Data', 'بيانات'),
  'excel.tab_view': ('Görünüm', 'View', 'عرض'),
  'excel.filter': ('Süz', 'Filter', 'تصفية'),
  'excel.zoom_in': ('Yakınlaştır', 'Zoom in', 'تكبير'),
  ...
  'excel.sort_needs_range': (
    'Sıralamak için önce satırları seçin (basılı tutup kaydırın) ya da tabloya süzgeç ekleyin.',
    'To sort, first select the rows (press and drag) or add a filter to the table.',
    'للترتيب، حدد الصفوف أولاً (اضغط واسحب) أو أضف تصفية إلى الجدول.',
  ),
  'excel.filter_needs_table': (
    'Bu sütunda süzgeç yok. Süzgeç, dosyada tanımlı tablo aralığında çalışır.',
    'No filter on this column. Filtering works on the table range defined in the file.',
    'لا توجد تصفية على هذا العمود. تعمل التصفية على نطاق الجدول المحدد في الملف.',
  ),
  'excel.saved_as_xlsx': (
    '{name} olarak kaydedildi (eski .xls dosyanız olduğu gibi duruyor)',
    'Saved as {name} (your original .xls file is untouched)',
    'تم الحفظ باسم {name} (ملف .xls الأصلي كما هو)',
  ),
  ...
  'fmset.start_folder_none': (
    'Uygulama panoyla açılır',
    'The app opens on the dashboard',
    'يفتح التطبيق على اللوحة',
  ),
  'fmset.start_folder_pick': (
    'Açılışta burayı aç',
    'Open this at startup',
    'افتح هذا عند البدء',
  ),
  'fmset.start_folder_clear': (
    'Açılış klasörünü kaldır',
    'Clear the start folder',
    'إزالة مجلد البداية',
  ),
  ...
  // ── Uygulamanın kapladığı alan (2026-09-26) ─────────────────────────────
  'foot.section': ('Uygulamanın alanı', 'App storage', 'مساحة التطبيق'),
  'foot.title': (
    'Uygulamanın kapladığı alan',
    'Storage used by the app',
    'المساحة التي يشغلها التطبيق',
  ),
  'foot.tile_sub': (
    'Neyin ne kadar yer tuttuğunu gör; önbelleği ve kopyaları temizle',
    'See what takes how much space; clear the cache and copies',
    'اعرف ما يشغل المساحة؛ امسح ذاكرة التخزين المؤقت والنسخ',
  ),
  'foot.kw_cache': ('önbellek boyut yer', 'cache size space', 'ذاكرة مؤقتة حجم مساحة'),
  'foot.total_sub': (
    'Uygulamanın kendi klasörlerinde (veri + önbellek). Uygulamanın kendisi (APK) bunun dışında.',
    'In the app’s own folders (data + cache). The app itself (APK) is not included.',
    'في مجلدات التطبيق نفسه (بيانات + ذاكرة مؤقتة). التطبيق نفسه (APK) غير مشمول.',
  ),
  'foot.system': (
    'Android’e göre: uygulama {app} · veri {data}',
    'According to Android: app {app} · data {data}',
    'حسب أندرويد: التطبيق {app} · البيانات {data}',
  ),
  'foot.empty': ('Ölçülecek bir şey yok.', 'Nothing to measure.', 'لا شيء لقياسه.'),
  'foot.shared': ('Paylaşım kopyaları', 'Share copies', 'نسخ المشاركة'),
  'foot.shared_sub': (
    '“Birlikte aç” ile gelen ve paylaşım için hazırlanan dosyaların kopyası; 7 günde kendiliğinden silinir',
    'Copies of files opened with “Open with” or prepared for sharing; removed automatically after 7 days',
    'نسخ الملفات المفتوحة عبر «فتح باستخدام» أو المُعدّة للمشاركة؛ تُحذف تلقائيًا بعد 7 أيام',
  ),
  'foot.picker': ('Dosya seçici kopyaları', 'File picker copies', 'نسخ منتقي الملفات'),
  'foot.picker_sub': (
    'Seçici ile seçilen dosyaların kopyası; 7 günde kendiliğinden silinir',
    'Copies of files chosen with the picker; removed automatically after 7 days',
    'نسخ الملفات المختارة بالمنتقي؛ تُحذف تلقائيًا بعد 7 أيام',
  ),
  'foot.thumbs': ('Küçük resimler', 'Thumbnails', 'الصور المصغّرة'),
  'foot.thumbs_sub': (
    'Video, PDF ve APK önizlemeleri — gerektikçe yeniden üretilir',
    'Video, PDF and APK previews — regenerated when needed',
    'معاينات الفيديو وPDF وAPK — يُعاد إنشاؤها عند الحاجة',
  ),
  'foot.temp': ('Geçici dosyalar', 'Temporary files', 'الملفات المؤقتة'),
  'foot.temp_sub': (
    'Tarama ara kareleri, arşiv önizlemeleri, WebView önbelleği',
    'Scan intermediates, archive previews, WebView cache',
    'ملفات المسح الوسيطة ومعاينات الأرشيف وذاكرة WebView المؤقتة',
  ),
  'foot.drive': ('Google Drive önbelleği', 'Google Drive cache', 'ذاكرة Google Drive المؤقتة'),
  'foot.drive_sub': (
    'Drive’dan açılan dosyaların yerel kopyası — yeniden açınca tekrar iner',
    'Local copies of files opened from Drive — downloaded again when reopened',
    'نسخ محلية لملفات فُتحت من Drive — تُنزَّل مجددًا عند فتحها',
  ),
  'foot.models': ('Çeviri dil modelleri', 'Translation language models', 'نماذج لغات الترجمة'),
  'foot.models_sub': (
    'Cihaz içi çeviri için indirilen modeller (dil başına ~30 MB)',
    'Models downloaded for on-device translation (~30 MB per language)',
    'نماذج نُزّلت للترجمة على الجهاز (~30 ميغابايت لكل لغة)',
  ),
  'foot.docs': ('Uygulama içindeki belgeler', 'Documents inside the app', 'مستندات داخل التطبيق'),
  'foot.docs_sub': (
    'Eski taramalar ve yeni belgeler — SİZİN dosyalarınız, temizlenmez. Uygulama kaldırılınca silinirler; dokunup Belgeler klasörüne taşıyın',
    'Older scans and new documents — YOUR files, never cleared. They are deleted if the app is uninstalled; tap and move them to Documents',
    'مسوحات قديمة ومستندات جديدة — ملفاتك، لا تُمسح. تُحذف عند إلغاء تثبيت التطبيق؛ اضغط وانقلها إلى المستندات',
  ),
  'foot.other': ('Ayarlar ve dizinler', 'Settings and indexes', 'الإعدادات والفهارس'),
  'foot.other_sub': (
    'Arama dizini, geçmiş, ayarlar, WebView verisi',
    'Search index, history, settings, WebView data',
    'فهرس البحث والسجل والإعدادات وبيانات WebView',
  ),
  'foot.clean': ('Önbelleği temizle ({size})', 'Clear cache ({size})', 'مسح الذاكرة المؤقتة ({size})'),
  'foot.clean_note': (
    'Kopyalar, küçük resimler, geçici dosyalar ve Drive önbelleği silinir. Belgelerinize dokunulmaz; son 10 dakikada açılanlar atlanır.',
    'Copies, thumbnails, temporary files and the Drive cache are deleted. Your documents are untouched; items opened in the last 10 minutes are skipped.',
    'تُحذف النسخ والصور المصغّرة والملفات المؤقتة وذاكرة Drive. لا تُمسّ مستنداتك؛ ويُتخطّى ما فُتح في آخر 10 دقائق.',
  ),
  'foot.freed': ('{size} boşaltıldı.', '{size} freed.', 'تم تحرير {size}.'),
  'foot.nothing_freed': (
    'Boşaltılacak bir şey kalmadı.',
    'Nothing left to free.',
    'لم يتبقَّ شيء لتحريره.',
  ),
  'foot.delete_models': ('Dil modellerini sil', 'Delete language models', 'حذف نماذج اللغات'),
  'foot.models_deleted': (
    '{n} dil modeli silindi; gerektiğinde yeniden iner.',
    '{n} language models deleted; they download again when needed.',
    'تم حذف {n} من نماذج اللغات؛ تُنزَّل مجددًا عند الحاجة.',
  ),
  'foot.apk_note': (
    'Uygulamanın kendisi (~95 MB) çoğunlukla cihaz içinde çalışan motorlardan oluşur: metin tanıma (OCR), çeviri, video, PDF. Bunlar internet gerektirmeden çalışsın diye pakette gelir.',
    'The app itself (~95 MB) is mostly on-device engines: text recognition (OCR), translation, video, PDF. They ship in the package so they work without internet.',
    'التطبيق نفسه (~95 ميغابايت) معظمه محركات تعمل على الجهاز: التعرّف على النص (OCR) والترجمة والفيديو وPDF. تأتي ضمن الحزمة لتعمل دون إنترنت.',
  ),
  'foot.system_settings': (
  ...
  // ── Arka planda çalma (2026-09-02) ───────────────────────────────────
  'mp.channel_name': ('Müzik çalar', 'Music player', 'مشغل الموسيقى'),
  'mp.channel_desc': (
    'Arka planda çalan ses dosyası bildirimi',
    'Notification for audio playing in the background',
    'إشعار الصوت الذي يعمل في الخلفية',
  ),
  ...
  'mp.background_on': (
    ...
    'يستمر التشغيل في الخلفية',
  ),
  'mp.now_playing': ('Çalıyor', 'Now playing', 'قيد التشغيل'),
  'mp.speed': ('Hız', 'Speed', 'السرعة'),
  'mp.back10': ('10 sn geri', 'Back 10s', 'إرجاع 10 ثوانٍ'),
  'mp.forward10': ('10 sn ileri', 'Forward 10s', 'تقديم 10 ثوانٍ'),
  'mp.portrait': ('Dikey', 'Portrait', 'عمودي'),
  'mp.fullscreen': (
    'Tam ekran (yatay)',
    'Full screen (landscape)',
    'ملء الشاشة (أفقي)',
  ),
  'mp.next_page': ('Sonraki sayfa', 'Next page', 'الصفحة التالية'),
  'mp.play_speed': ('Oynatma hızı', 'Playback speed', 'سرعة التشغيل'),
  'mp.subtitles': ('Altyazı', 'Subtitles', 'الترجمة'),
  'mp.sub_off': ('Altyazı kapalı', 'Subtitles off', 'إيقاف الترجمة'),
  'mp.sub_pick': (
    'Dosyadan altyazı seç…',
    'Choose subtitle file…',
    'اختيار ملف ترجمة…',
  ),
  'mp.sub_earlier': (
    'Altyazıyı 0,5 sn öne al',
    'Shift subtitles 0.5 s earlier',
    'تقديم الترجمة 0.5 ثانية',
  ),
  'mp.sub_later': (
    'Altyazıyı 0,5 sn geciktir',
    'Shift subtitles 0.5 s later',
    'تأخير الترجمة 0.5 ثانية',
  ),
  'mp.sub_offset': ('Kayma: {v} sn', 'Offset: {v} s', 'الإزاحة: {v} ثانية'),
  'mp.sub_unreadable': (
    'Altyazı dosyası okunamadı.',
